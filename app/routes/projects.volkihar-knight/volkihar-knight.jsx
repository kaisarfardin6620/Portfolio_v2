...
const description =
  'An end-to-end AI storytelling platform combining GPT-4o, DALL·E, ElevenLabs, Celery chains, and realtime progress updates.';
const roles = ['GPT-4o', 'DALL·E', 'ElevenLabs', 'Celery'];
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectImage
              ...
              alt="Story generation platform hero screen"
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <Image
              ...
              alt="Story package and asset planning"
        ...
        <ProjectSection>
          <ProjectSectionColumns>
            <div className={styles.armor}>
              <Suspense>
                <Armor alt="3D model of the story backend flow" />
              </Suspense>
            </div>
            <div className={styles.textSection}>
              <ProjectSectionHeading>Asynchronous generation pipeline</ProjectSectionHeading>
              <ProjectSectionText>
                This backend orchestrates long-running story generation with Celery chains,
                coordinating text generation, image creation, and voice synthesis into a
                single workflow.
              </ProjectSectionText>
              <ProjectSectionText>
                A realtime progress channel keeps users informed while work is processed in
                the background.
              </ProjectSectionText>
            </div>
          </ProjectSectionColumns>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center noMargin>
              ...
              />
              <ProjectSectionHeading>Subscription and delivery</ProjectSectionHeading>
              <ProjectSectionText>
                The service includes subscription handling, API security controls, Docker
                deployment, and production configuration for scalable SaaS delivery.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
                ...
                images={[
                  {
                    ...
                    alt: 'Generated story output screen.',
                  },
                  {
                    srcSet: `${volkiharSlide2} 960w, ${volkiharSlide2Large} 1920w`,
                    sizes: `(max-width: ${media.mobile}px) 100vw, (max-width: ${media.tablet}px) 100vw, 1096px`,
                    alt: 'Audio and voice synthesis settings.',
                  },
                  {
                    srcSet: `${volkiharSlide3} 960w, ${volkiharSlide3Large} 1920w`,
                    sizes: `(max-width: ${media.mobile}px) 100vw, (max-width: ${media.tablet}px) 100vw, 1096px`,
                    alt: 'Background job progress and publishing flow.',
                  },
                ]}
                width={1920}
                height={1080}
        ...
        <ProjectSection
          backgroundElement={
            <Image
              ...
              alt="Background visual for the backend system"
              sizes={`100vw`}
            />
          }
        >

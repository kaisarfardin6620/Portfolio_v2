...
const title = 'Explainable Hybrid KG-RAG Assistant';
const description =
  'A production-ready assistant combining vector retrieval, knowledge graph traversal, and NLI-based claim verification to improve reliability and reduce hallucinations.';
const roles = ['FastAPI', 'Neo4j', 'Pinecone', 'NLI Validation'];
      ...
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              Standard RAG pipelines can retrieve relevant chunks but still produce
              ungrounded statements under multi-hop questions. This project focused on
              building an explainable assistant where every critical claim can be traced
              back to retrieved evidence.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
        <ProjectSection light={isDark}>
          <ProjectSectionContent>
            ...
            <ProjectTextRow>
              <ProjectSectionHeading>Hybrid retrieval architecture</ProjectSectionHeading>
              <ProjectSectionText>
                I combined Pinecone vector retrieval with Neo4j graph traversal so the
                generation layer receives both semantic context and entity relationships.
                This substantially improved grounding on complex, connected queries.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectSectionContent>
            ...
            />
            <ProjectTextRow>
              <ProjectSectionHeading>Verification pipeline</ProjectSectionHeading>
              <ProjectSectionText>
                To reduce hallucinations, generated responses are split into atomic claims
                and validated with NLI-style checks against retrieved context. This added
                a practical trust layer for production use cases.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  <ProjectSectionHeading>Production engineering</ProjectSectionHeading>
                  <ProjectSectionText>
                    The service was implemented with robust API contracts, async job
                    processing, and backend safeguards for stable enterprise usage under
                    sustained load.
                  </ProjectSectionText>
                </ProjectTextRow>
              </ProjectSectionContent>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                The assistant shipped as a client project with stronger factual grounding,
                better multi-hop answer quality, and an explainability layer suitable for
                high-trust enterprise workflows.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
